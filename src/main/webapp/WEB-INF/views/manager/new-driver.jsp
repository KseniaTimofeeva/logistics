                ...
                <div class="card">
                    ...
                    <form action="<c:url value="/manager/driver/new"/>" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="last-name">Personal number</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="last-name">Login</label>
                                <div class="col-md-9">
                            ...
                            <c:choose>
                                <c:when test="${updatedDriver == null}">
                                    <div class="form-group row">
                                        <label class="col-md-3 form-control-label" for="last-name">Password</label>
                                        <div class="col-md-9">
